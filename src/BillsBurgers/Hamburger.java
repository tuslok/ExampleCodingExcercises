...
Remember that a name and price must be accepted as parameters in the first four methods so that the price of the hamburger is adjusted accordingly. These methods should be named addHamburgerAddition1, addHamburgerAddition2, addHamburgerAddition3, addHamburgerAddition4, and itemizehamburger.
...
public class Hamburger {
    ...
    public double itemizeHamburger() {
        ...
        if (addition1Price > 0 && addition1Name != null) {
            price = price + this.addition1Price;
        }
        if (addition2Price > 0 && addition2Name != null) {
            price = price + this.addition2Price;
        }
        if (addition3Price > 0 && addition3Name != null){
            price = price + this.addition3Price;
        }
        if (addition4Price > 0 && addition4Name != null){
            price = price + this.addition4Price;
        }
        return price;
    }
}
