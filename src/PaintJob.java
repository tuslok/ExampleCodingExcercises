public class PaintJob {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double atHome = areaPerBucket * extraBuckets;
        double restOfWall = areaToPaint - atHome;
        int bucket = (int) (restOfWall / areaPerBucket) +1;
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket) {
        ...
        double areaToPaint = width * height;
        double needToBuy = (areaToPaint / areaPerBucket);
        return (int) Math.ceil(needToBuy);
